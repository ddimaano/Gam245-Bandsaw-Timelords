...
if counter >= 20{
	//puzzle is complete
	//take screenshot
	screen_save(working_directory+"\Screenshots\Screen"+string(num)+ ".png");
	num++;
	//check room
