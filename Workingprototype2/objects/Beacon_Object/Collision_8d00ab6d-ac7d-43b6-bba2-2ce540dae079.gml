...
/// @DnDVersion : 1
/// @DnDHash : 4A13F3E8
/// @DnDArgument : "code" "instance_create_layer(1120, 480, "Instances", sat1_Dipper);$(13_10)instance_create_layer(1056, 288, "Instances", sat3_Capricorn);$(13_10)instance_create_layer(736, 320, "Instances", sat2_Libra);$(13_10)GameStart.Starscore += 1;$(13_10)$(13_10)$(13_10)// create two stars since there is more area to cover$(13_10)$(13_10)instance_create_layer(random(4000), random(4000), "Instances", Beacon_Object);$(13_10)instance_create_layer(random(4000), random(4000), "Instances", Beacon_Object);"
