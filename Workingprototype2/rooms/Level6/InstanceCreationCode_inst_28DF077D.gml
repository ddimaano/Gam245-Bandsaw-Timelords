...
if room = cons10_newSet3 {
	path_start(newSet3_Path3, 1.3, path_action_continue, true);
	path_position = 0.33;
}

if room = cons11_newSet4 {
	path_start(newSet4_Path1, 1.5, path_action_restart, true);
	path_position = 0;
}